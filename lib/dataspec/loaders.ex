defmodule DataSpec.Loaders do
  ...
  def literal(literal, value, _type_params_loaders) do
    case value do
      ^literal -> value
  ...
  def any(value, _type_params_loaders) do
    value
  end

  def atom(value, _type_params_loaders) do
    case value do
  ...
  def boolean(value, _type_params_loaders) do
    case value do
  ...
  def binary(value, _type_params_loaders) do
    case value do
  ...
  def pid(value, _type_params_loaders) do
    case value do
  ...
  def reference(value, _type_params_loaders) do
    case value do
  ...
  def number(value, _type_params_loaders) do
    case value do
  ...
  def float(value, _type_params_loaders) do
    case value do
  ...
  def integer(value, _type_params_loaders) do
    case value do
  ...
  def neg_integer(value, _type_params_loaders) do
    case value do
  ...
  def non_neg_integer(value, _type_params_loaders) do
    case value do
      value when is_integer(value) and value >= 0 -> value
  ...
  def pos_integer(value, _type_params_loaders) do
    case value do
      value when is_integer(value) and value > 0 -> value
  ...
  def range(lower, upper, value, _type_params_loaders) do
    case value do
  ...
  def union(value, type_params_loaders) do
    type_params_loaders
    |> Enum.reduce_while(:error, fn loader, _ ->
      try do
        {:halt, {:ok, loader.(value, [])}}
      rescue
        Error ->
          {:cont, :error}
      end
  ...
  def empty_list(value, _type_params_loaders) do
    case value do
      [] -> value
  ...
  def nonempty_list(value, _type_params_loaders) do
    case value do
      [_ | _] -> value
  ...
  def list(value, [type_params_loader]) do
    case value do
      value when is_list(value) -> Enum.map(value, &type_params_loader.(&1, []))
  ...
  def map_field_required(map, [type_key_loader, type_value_loader]) do
    {map_rest, map_processed} = map_field_optional(map, [type_key_loader, type_value_loader])
  ...
  def map_field_optional(map, [type_key_loader, type_value_loader]) do
    case map do
      map when is_map(map) ->
        Enum.reduce(map, {map, %{}}, fn {map_key, map_value}, {map_rest, map_processed} ->
          try do
            map_key_processed = type_key_loader.(map_key, [])
            map_value_processed = type_value_loader.(map_value, [])
  ...
  def tuple(value, type_params_loaders) do
    case value do
      value when is_tuple(value) ->
        value
        |> Tuple.to_list()
        |> Enum.zip(type_params_loaders)
        |> Enum.map(fn {item, loader} -> loader.(item, []) end)
        |> List.to_tuple()
